  ...
  return (
    <section className="py-16 px-6 bg-gray-900">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold mb-12 text-center text-white">How Fixify Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="text-center">
              <div className="orange-bg text-black w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl">
                {step.number}
              </div>
