...
const Footer: FC = () => {
  return (
    <footer className="bg-white py-12 px-6 border-t border-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-600 hover:text-[#ff9900]">
                <FaFacebookF />
              </a>
              <a href="#" className="text-gray-600 hover:text-[#ff9900]">
                <FaTwitter />
          ...
          {/* For Customers */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-black">For Customers</h3>
          ...
          {/* For Freelancers */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-black">For Freelancers</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-[#ff9900]">
                  Become a Freelancer
